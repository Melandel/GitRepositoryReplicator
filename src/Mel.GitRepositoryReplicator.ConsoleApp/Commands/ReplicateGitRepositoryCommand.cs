...
class ReplicateGitRepositoryCommand : Command
{
	...
	public override void Execute()
	{
		...
		var targetRepositoryPath = Application.FolderPath.From(_targetRepositoryPath);
		...
		var targetRepositoryApiLanguage = _targetRepositoryApiLanguage.ToApplicationLanguage();
		var targetRepositoryMessagesLanguage = _targetRepositoryMessagesLanguage.ToApplicationLanguage();
		var targetRepositoryDocumentationLanguage = _targetRepositoryDocumentationLanguage.ToApplicationLanguage();
		var targetRepositoryCommitMessagesLanguage = _targetRepositoryCommitMessagesLanguage.ToApplicationLanguage();
