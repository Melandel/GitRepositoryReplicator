...
public class ObjectConstructionException : Exception
{
	...
	=> WhenConstructingAnInstanceOf<TObjectUnderConstruction>(
	...
	=> WhenConstructingAnInstanceOf<TObjectUnderConstruction>(
		ruleThatInvalidatesTheInstanceConstruction,
		constructionMethodParameters: new[] { constructionMethodParameter },
		callerMethodName);

	public static ObjectConstructionException WhenConstructingAnInstanceOf<TObjectUnderConstruction>(
		string ruleThatInvalidatesTheInstanceConstruction,
		object? constructionMethodParameter1,
		object? constructionMethodParameter2,
		[CallerMemberName] string callerMethodName = "")
	=> WhenConstructingAnInstanceOf<TObjectUnderConstruction>(
		ruleThatInvalidatesTheInstanceConstruction,
		constructionMethodParameters: new[] { constructionMethodParameter1, constructionMethodParameter2 },
		callerMethodName);
	...
	public static ObjectConstructionException WhenConstructingAnInstanceOf<TObjectUnderConstruction>(
		...
		object? constructionMethodParameter1,
		object? constructionMethodParameter2,
		object? constructionMethodParameter3,
		[CallerMemberName] string callerMethodName = "")
	=> WhenConstructingAnInstanceOf<TObjectUnderConstruction>(
		ruleThatInvalidatesTheInstanceConstruction,
		constructionMethodParameters: new[] { constructionMethodParameter1, constructionMethodParameter2, constructionMethodParameter3 },
		callerMethodName);
	...
	public static ObjectConstructionException WhenConstructingAnInstanceOf<TObjectUnderConstruction>(
		...
		object? constructionMethodParameter2,
		object? constructionMethodParameter3,
		object? constructionMethodParameter4,
		[CallerMemberName] string callerMethodName = "")
	=> WhenConstructingAnInstanceOf<TObjectUnderConstruction>(
		ruleThatInvalidatesTheInstanceConstruction,
		constructionMethodParameters: new[] { constructionMethodParameter1, constructionMethodParameter2, constructionMethodParameter3, constructionMethodParameter4 },
		callerMethodName);
	...
	public ObjectConstructionException EnrichWithInformationAbout<TObjectUnderConstruction>(
		[CallerMemberName] string callerMethodName = "")
	=> EnrichWithInformationAbout<TObjectUnderConstruction>(
		constructionMethodParameters: Array.Empty<object?>(),
		callerMethodName);
		...
		string callerMethodName = "")
	{
		...
		{
			sb.Append($"when called from {BuildCallerMethodPartialSignature(objectUnderConstruction, callerMethodName)}, ");
		}
