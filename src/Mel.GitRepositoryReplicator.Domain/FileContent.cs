...
public record FileContent
{
	...
	=> new(
		_content
			.ReplaceCaseInsensitive(_sourceRepositoryRootNamespace, targetRepositoryRootNamespace),
		_sourceRepositoryName,
		_sourceRepositoryRootNamespace);
	...
	public FileContent AdaptDocumentationLanguageTo(Language targetRepositoryMessagesLanguage)
	{
		return this;
	}
}
