...
record ConsoleAppArguments
{
	...
	public static ConsoleAppArguments From(string[] args, ILanguageResolver languageResolver)
	{
		try
		{
			...
			var targetRepositoryApiLanguage = languageResolver.Resolve("en");
			var targetRepositoryMessagesLanguage = languageResolver.Resolve("en");
			var targetRepositoryDocumentationLanguage = languageResolver.Resolve("fr");
			var targetRepositoryCommitMessagesLanguage = languageResolver.Resolve("en");
